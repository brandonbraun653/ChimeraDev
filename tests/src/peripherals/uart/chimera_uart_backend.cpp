...
namespace Chimera::UART::Testing
{
  ...
  static Chimera::UART::Driver_sPtr testDriverObj;
...
namespace Chimera::UART::Backend
{
  ...
  namespace Standard
  {
    ...
    static bool isChannelUART( const Chimera::Serial::Channel channel )
    {
      return true;
    }

    static Chimera::UART::Driver_sPtr getDriver( const Chimera::Serial::Channel channel )
    {
      if ( !Testing::testDriverObj )
      {
        Testing::testDriverObj = std::make_shared<Chimera::UART::Driver>();
      }
  ...
  Chimera::Status_t registerDriver( Chimera::UART::Backend::DriverConfig &registry )
  {
    switch ( Testing::currentDriver )
    {
      case Testing::DRIVER_STANDARD:
        ...
        registry.isChannelUART = Standard::isChannelUART;
        return Chimera::Status::OK;
        break;
